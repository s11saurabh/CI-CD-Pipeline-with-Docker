...
![Jenkins CI_CD Pipeline with Docker and GitHub](https://github.com/s11saurabh/CI-CD-Pipeline-with-Docker/assets/130890384/ab868d34-cfc4-4079-95b8-0b584622add5)
...
4. Create a new Jenkins job and configure it as follows:
   ...
   - Connect it to your GitHub repository (https://github.com/s11saurabh/CI-CD-Pipeline-with-Docker.git) and configure the webhook.
